...
# Use 180 measurements over 0-17.9 s; evaluate extrapolation from 18 s.
# This setting fits the current initial angles (-22.5 deg, +18 deg).
DATA_STOP = 1800
DATA_STEP = 10
...
def main():
    ...
    for epoch in range(EPOCHS + 1):
        ...
        if epoch % PRINT_EVERY == 0:
            ...
            print(
                f"\rEpoch {epoch:6d} | Loss {total_loss.item():.3e} | "
                f"Time {elapsed}",
                end='',
                flush=True,
            )
