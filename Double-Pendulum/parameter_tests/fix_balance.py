...
jobs=[('fix_window10_p10',{'DATA_STOP':1000,'DATA_STEP':10,'LAMBDA_PHYSICS':10.}),('fix_window15_p10',{'DATA_STOP':1500,'DATA_STEP':10,'LAMBDA_PHYSICS':10.}),('fix_window18_p10',{'DATA_STOP':1800,'DATA_STEP':10,'LAMBDA_PHYSICS':10.})]
def run(j):
 name,params=j
